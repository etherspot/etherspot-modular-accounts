...
/// @title Execution
/// @notice Represents a single transaction to be executed by a smart contract wallet
/// @dev Used primarily in batch execution contexts to define transaction parameters
struct Execution {
    address target;
    uint256 value;
    bytes callData;
