...
contract StakeWalletFactoryScript is Script {
    address constant ENTRY_POINT_07 = 0x0000000071727De22E5E9d8BAf0edAc6f37da032;
    address payable constant EXPECTED_WALLET_FACTORY = payable(0x2A40091f044e48DEB5C0FCbc442E443F3341B451);

    function run() external {
        uint256 deployerPrivateKey = vm.envUint("DEPLOYER_PRIVATE_KEY");
        vm.startBroadcast(deployerPrivateKey);

        ModularEtherspotWalletFactory factory = ModularEtherspotWalletFactory(EXPECTED_WALLET_FACTORY);
        IEntryPoint entryPoint = IEntryPoint(ENTRY_POINT_07);

        /*//////////////////////////////////////////////////////////////
                                Starting Staking
        //////////////////////////////////////////////////////////////*/
        console2.log("Starting staking sequence...");
        ...
        IStakeManager.DepositInfo memory info = entryPoint.getDepositInfo(EXPECTED_WALLET_FACTORY);
