...
contract ModularEtherspotWalletFactoryScript is Script {
    address public constant DEPLOYER = address(0x09FD4F6088f2025427AB1e89257A44747081Ed59);
    ...
    function run() external {
        ...
        if (EXPECTED_FACTORY.code.length == 0) {
            ModularEtherspotWalletFactory factory =
                new ModularEtherspotWalletFactory{salt: SALT}(EXPECTED_IMPLEMENTATION, DEPLOYER);
