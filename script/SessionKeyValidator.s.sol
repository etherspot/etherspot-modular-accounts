...
contract SessionKeyValidatorScript is Script {
    bytes32 immutable SALT = bytes32(abi.encodePacked("SessionKeyValidator:Create2:salt"));
    ...
    function run() external {
        ...
        SessionKeyValidator sessionKeyValidator = new SessionKeyValidator{salt: SALT}();
        console2.log("SessionKeyValidator deployed at address", address(sessionKeyValidator));
