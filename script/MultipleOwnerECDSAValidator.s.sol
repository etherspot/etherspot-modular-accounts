...
contract MultipleOwnerECDSAValidatorScript is Script {
    bytes32 immutable SALT = bytes32(abi.encodePacked("ModularEtherspotWallet:Create2:salt"));
    address constant EXPECTED_MULTIPLE_OWNER_ECDSA_VALIDATOR = 0x0740Ed7c11b9da33d9C80Bd76b826e4E90CC1906;
    ...
    function run() external {
        ...
        if (EXPECTED_MULTIPLE_OWNER_ECDSA_VALIDATOR.code.length == 0) {
            MultipleOwnerECDSAValidator multipleOwnerECDSAValidator = new MultipleOwnerECDSAValidator{salt: SALT}();
